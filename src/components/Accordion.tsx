  ...
  return (
    ...
    <div className="bg-white text-[#181028] p-8 space-y-6 shadow-[20px_19px_25px_2px_rgba(0,0,0,0.1)] rounded-xl max-w-md md:max-w-lg text-left">
        ...
        <ul className="text-xs font-semibold pb-7 list-none grid grid-cols-[1fr_8fr] text-left">
            ...
            <button className='col-start-1 col-end-1 border-b' onClick={() => Spin()}>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className={spinning}><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
            </button>
